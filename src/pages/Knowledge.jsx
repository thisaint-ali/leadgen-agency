  ...
  return (
    ...
    <div className="p-6 max-w-3xl mx-auto">
      ...
      <div className="mb-6">
        ...
        <h1 className="text-xl font-semibold font-mono text-gray-900">Knowledge Base</h1>

        <p className="text-sm text-gray-500 font-mono mt-1">Full reference for running a Google Ads lead gen agency</p>
        ...
        {SECTIONS.map(({ title, content }) => (
          ...
          <div key={title} className="border border-gray-100 rounded-xl overflow-hidden">
            ...
            <div className="px-4 py-4">
              ...
              <pre className="text-xs font-mono text-gray-600 whitespace-pre-wrap leading-relaxed">{content}</pre>
